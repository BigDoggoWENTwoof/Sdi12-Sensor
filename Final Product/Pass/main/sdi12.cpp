...
void sdiSend(String response) {
  ...
  // txLockoutUntil is set to prevent the next command from being sent too soon
  // this is to prevent the SDI-12 from being overwhelmed by commands
  // it is set to the current time plus the TX_LOCKOUT_MS
  // TX_LOCKOUT_MS is 50ms
